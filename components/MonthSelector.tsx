...
function MonthSelector({
  ...
  return (
    <nav 
      className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 bg-card p-2 rounded-lg shadow"
    ...
    >
      ...
      <div className="w-full sm:w-auto text-center sm:order-0">
        ...
        >
          ...
          {isCurrent && (
            <span className="ml-2 text-xs font-normal uppercase text-primary-foreground px-1.5 py-0.5 rounded-md bg-primary" aria-label="(mes actual)">
              Actual
            </span>
          )}
        </h2>
